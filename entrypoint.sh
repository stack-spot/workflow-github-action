...
put_workflow_json='{"extra_inputs": "'"$extra_inputs"'"}'
http_code=$(curl --request PUT -s -o output.json -w '%{http_code}' "$put_workflow_url" --header "Authorization: Bearer $secret_stk_login" --data "$put_workflow_json";)
